...
<form role="form" method="post" action="<?php echo e(url($path)); ?>/<?php echo e($data->id); ?>" enctype="multipart/form-data">
	...
	<div class="portlet light bordered">
    	...
    	<div class="portlet-body form">
			...
			<div class="row">
			  	<?php echo view($view_path.'.builder.text',['type' => 'text','name' => 'youtube_url','label' => 'Youtube URL','value' => (old('youtube_url') ? old('youtube_url') : $data->youtube_url),'attribute' => 'autofocus required','form_class' => 'col-md-6 youtube_url_wrapper', 'class' => 'youtube_url', 'placeholder' => 'https://www.youtube.com/watch?v=We9fYv6iLWg']); ?>
