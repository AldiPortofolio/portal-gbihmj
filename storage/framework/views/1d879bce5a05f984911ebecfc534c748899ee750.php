	...
	<div class="portlet light bordered">
    	...
    	<div class="portlet-body form">
  			...
  			<div class="row">
				...
				<?php echo view($view_path.'.builder.text',['type' => 'text','name' => 'booking_code','label' => 'Booking Code','value' => (old('booking_code') ? old('booking_code') : $data->booking_code),'attribute' => 'required autofocus readonly','form_class' => 'col-md-12', 'required' => 'y']); ?>

				
				<?php echo view($view_path.'.builder.text',['type' => 'text','name' => 'event_title','label' => 'Event Title','value' => (old('event_title') ? old('event_title') : $data->event_title),'attribute' => 'required autofocus readonly','form_class' => 'col-md-12', 'required' => 'y']); ?>


				<?php echo view($view_path.'.builder.text',['type' => 'text','name' => 'name','label' => 'Booked By','value' => (old('name') ? old('name') : $data->name),'attribute' => 'required autofocus readonly','form_class' => 'col-md-12', 'required' => 'y']); ?>

				
				<?php echo view($view_path.'.builder.text',['type' => 'text','name' => 'phone','label' => 'Phone','value' => (old('phone') ? old('phone') : $data->phone),'attribute' => 'required autofocus readonly','form_class' => 'col-md-12', 'required' => 'y']); ?>


				<?php echo view($view_path.'.builder.text',['type' => 'text','name' => 'email','label' => 'Email','value' => (old('email') ? old('email') : $data->email),'attribute' => 'required autofocus readonly','form_class' => 'col-md-12', 'required' => 'y']); ?>

				
				<?php echo view($view_path.'.builder.text',['type' => 'text','name' => 'time','label' => 'Time','value' => (old('time') ? old('time') : $data->time),'attribute' => 'required autofocus readonly','form_class' => 'col-md-12', 'required' => 'y']); ?>
				...
				<div class="col-md-12" id="">
  				...
  				<input type="hidden" id="root-url" value="<?php echo e($path); ?>" />
			</div>	
