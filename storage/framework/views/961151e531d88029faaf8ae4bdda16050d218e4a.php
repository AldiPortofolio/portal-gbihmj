      		...
      		<div class="row">				
			  	<div class="form-group form-md-line-input col-md-12">
					...
					<label class="btn green input-file-label-image">
						<input type="file" class="form-control col-md-12 single-file" name="file" value="<?php echo e($file_path.$data->file); ?>"> Pilih File
							</label>
				...
				<div class="form-group single-file_wrapper single-file-file col-md-12"><a href="<?php echo e($base_url.'/'.$file_path.'/'.$data->file); ?>" target="_blank"><?php echo e($data->file); ?></a></div>
			</div>
