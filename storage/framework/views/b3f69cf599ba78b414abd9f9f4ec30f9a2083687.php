	  		...
	  		<div class="tabbable-line">
		        ...
		        <div class="tab-content">
		          	<div class="tab-pane active" id="church">	
						<div class="row">
							<?php echo view($view_path.'.builder.text',['type' => 'text','name' => 'name','label' => 'Church Name','value' => (old('name') ? old('name') : ''),'attribute' => 'required autofocus','form_class' => 'col-md-12', 'class' => 'church_name', 'required' => 'y']); ?>

							
							<?php echo view($view_path.'.builder.textarea',['type' => 'text','name' => 'address','label' => 'Address','value' => (old('address') ? old('address') : ''),'attribute' => 'required autofocus','form_class' => 'col-md-12', 'class' => 'church_name', 'required' => 'y']); ?>


							<?php echo view($view_path.'.builder.text',['type' => 'text','name' => 'province','label' => 'Province','value' => (old('province') ? old('province') : ''),'attribute' => 'required autofocus','form_class' => 'col-md-12', 'class' => 'province', 'required' => 'y']); ?>


							<?php echo view($view_path.'.builder.text',['type' => 'text','name' => 'city','label' => 'City','value' => (old('city') ? old('city') : ''),'attribute' => 'required autofocus','form_class' => 'col-md-12', 'class' => 'city', 'required' => 'y']); ?>


							<?php echo view($view_path.'.builder.text',['type' => 'text','name' => 'region_district','label' => 'Region District','value' => (old('region_district') ? old('region_district') : ''),'attribute' => 'required autofocus','form_class' => 'col-md-12', 'class' => 'region_district', 'required' => 'y']); ?>


							<?php echo view($view_path.'.builder.text',['type' => 'text','name' => 'latitude','label' => 'Latitude','value' => (old('latitude') ? old('latitude') : ''),'attribute' => 'required autofocus','form_class' => 'col-md-12', 'class' => 'latitude', 'required' => 'y']); ?>


							<?php echo view($view_path.'.builder.text',['type' => 'text','name' => 'longitude','label' => 'longitude','value' => (old('longitude') ? old('longitude') : ''),'attribute' => 'required autofocus','form_class' => 'col-md-12', 'class' => 'longitude', 'required' => 'y']); ?>
					...
					<div class="tab-pane" id="images">	
						<div class="row">
							<!-- <?php echo view($view_path.'.builder.file',['name' => 'image','label' => 'Church Image','value' => '','type' => 'file','file_opt' => ['path' => $image_path],'upload_type' => 'multiple-image','class' => 'col-md-12 image_wrapper','note' => 'Note: File Must jpeg,png,jpg,gif','form_class' => 'col-md-12', 'required' => 'n', 'attribute' => 'data-upload=ext/upload_image']); ?> -->
