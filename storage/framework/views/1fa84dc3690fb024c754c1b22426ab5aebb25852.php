	...
	<div class="portlet light bordered">
    	...
    	<div class="portlet-body form">
	  		...
	  		<div class="row">
				...
				<?php echo view($view_path.'.builder.file',['name' => 'image','label' => 'image','value' => '','type' => 'file','file_opt' => ['path' => $image_path],'upload_type' => 'single-image','class' => 'col-md-12','note' => 'Note: File Must jpeg,png,jpg,gif','form_class' => 'col-md-12', 'required' => 'y']); ?>
				...
				<div class="form-group single-audio_wrapper single-audio-music_name col-md-12"></div>
