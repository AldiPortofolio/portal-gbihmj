...
<form role="form" method="post" action="<?php echo e(url($path)); ?>/<?php echo e($data->id); ?>" enctype="multipart/form-data">
	...
	<div class="portlet light bordered">
    	...
    	<div class="portlet-body form">
      		...
      		<div class="row">
				<?php echo view($view_path.'.builder.select',['name' => 'church_id','label' => 'Church','value' => (old('church_id') ? old('church_id') : $data->church_id),'attribute' => 'required','form_class' => 'col-md-12', 'data' => $church, 'class' => 'select2 church_id', 'onchange' => '']); ?>
				...
				<?php echo view($view_path.'.builder.select',['name' => 'category_event','label' => 'Category Event','value' => (old('category_event') ? old('category_event') : $data->category_id),'attribute' => 'required','form_class' => 'col-md-12', 'data' => $category_event, 'class' => 'select2 category_event', 'onchange' => '']); ?>


				<?php echo view($view_path.'.builder.text',['type' => 'text','name' => 'title','label' => 'Title','value' => (old('title') ? old('title') : $data->title),'attribute' => 'required autofocus','form_class' => 'col-md-12', 'class' => 'title', 'required' => 'y']); ?>

				
				<?php echo view($view_path.'.builder.text',['type' => 'text','name' => 'sub_title','label' => 'Subtitle','value' => (old('sub_title') ? old('sub_title') : $data->sub_title),'attribute' => 'required autofocus','form_class' => 'col-md-12', 'class' => 'sub_title', 'required' => 'y']); ?>

				
				<?php echo view($view_path.'.builder.textarea',['type' => 'text','name' => 'content','label' => 'Content','value' => (old('content') ? old('content') : $data->content),'attribute' => 'required autofocus','form_class' => 'col-md-12', 'class' => 'content', 'required' => 'y']); ?>


				<?php echo view($view_path.'.builder.file',['name' => 'image','label' => 'Event Image','value' => $data->image,'type' => 'file','file_opt' => ['path' => $image_path],'upload_type' => 'single-image','class' => 'col-md-12','note' => 'Note: File Must jpeg,png,jpg,gif','form_class' => 'col-md-12', 'required' => 'n']); ?>


				<?php echo view($view_path.'.builder.text',['type' => 'text','name' => 'speaker','label' => 'Speaker','value' => (old('speaker') ? old('speaker') : $data->speaker),'attribute' => 'required autofocus','form_class' => 'col-md-12', 'class' => 'speaker', 'required' => 'y']); ?>


				<div class="col-md-6" id="">
		          <div class="form-group form-md-line-input">
		            <input type="text" id="event_date" class="form-control" name="event_date" value="<?php echo e(date_format(date_create($data->date), 'd-m-Y')); ?>" readonly="" placeholder="Event Date">
...
<?php $__env->startPush('custom_scripts'); ?>
	<script>
		$(document).ready(function(){
			...
			let $event_time = <?php echo $data->time;?>;
