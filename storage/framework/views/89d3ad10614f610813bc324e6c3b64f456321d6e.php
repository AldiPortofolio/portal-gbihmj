	  		...
	  		<div class="tabbable-line">
		        ...
		        <div class="tab-content">
		          	<div class="tab-pane active" id="church">	
						<div class="row">
							<?php echo view($view_path.'.builder.text',['type' => 'text','name' => 'name','label' => 'Church Name','value' => (old('name') ? old('name') : $data->name),'attribute' => 'required autofocus','form_class' => 'col-md-12', 'class' => 'church_name', 'required' => 'y']); ?>

							
							<?php echo view($view_path.'.builder.textarea',['type' => 'text','name' => 'address','label' => 'Address','value' => (old('address') ? old('address') : $data->address),'attribute' => 'required autofocus','form_class' => 'col-md-12', 'class' => 'church_name', 'required' => 'y']); ?>


							<?php echo view($view_path.'.builder.text',['type' => 'text','name' => 'province','label' => 'Province','value' => (old('province') ? old('province') : $data->province),'attribute' => 'required autofocus','form_class' => 'col-md-12', 'class' => 'province', 'required' => 'y']); ?>


							<?php echo view($view_path.'.builder.text',['type' => 'text','name' => 'city','label' => 'City','value' => (old('city') ? old('city') : $data->city),'attribute' => 'required autofocus','form_class' => 'col-md-12', 'class' => 'city', 'required' => 'y']); ?>


							<?php echo view($view_path.'.builder.text',['type' => 'text','name' => 'region_district','label' => 'Region District','value' => (old('region_district') ? old('region_district') : $data->region_district),'attribute' => 'required autofocus','form_class' => 'col-md-12', 'class' => 'region_district', 'required' => 'y']); ?>


							<?php echo view($view_path.'.builder.text',['type' => 'text','name' => 'latitude','label' => 'Latitude','value' => (old('latitude') ? old('latitude') : $data->latitude),'attribute' => 'required autofocus','form_class' => 'col-md-12', 'class' => 'latitude', 'required' => 'y']); ?>


							<?php echo view($view_path.'.builder.text',['type' => 'text','name' => 'longitude','label' => 'longitude','value' => (old('longitude') ? old('longitude') : $data->longitude),'attribute' => 'required autofocus','form_class' => 'col-md-12', 'class' => 'longitude', 'required' => 'y']); ?>
							...
							<table class="table table-borded table-responsive table-striped " id="table-list">
								...
								<tbody id="seat_tbody">
									<tr class="seat_row" id="">
										<td style="width: 25%;"><img class="img-responsive image_church" src="<?php echo e($base_url.'/'.$image_path.'zM7lYx_responsive_design_311890.jpg'); ?>"></td>
