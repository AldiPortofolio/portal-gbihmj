    ...
    <div class="portlet light bordered">
        ...
        <div class="portlet-body form">
            ...
            <div class="row">
                ...
                {!!view($view_path.'.builder.text',['type' => 'text','name' => 'name','label' => 'City Name','value' => (old('name') ? old('name') : $data->name),'attribute' => 'required autofocus','form_class' => 'col-md-6', 'class' => ''])!!}
