	  		...
	  		<div class="tabbable-line">
		        ...
		        <div class="tab-content">
		          	<div class="tab-pane active" id="room">	
						<div class="row">
							{!!view($view_path.'.builder.select',['name' => 'church_id','label' => 'Church','value' => (old('church_id') ? old('church_id') : ''),'attribute' => 'required','form_class' => 'col-md-12', 'data' => $church, 'class' => 'select2 user_access', 'onchange' => ''])!!}

							{!!view($view_path.'.builder.text',['type' => 'text','name' => 'room_name','label' => 'Room Name','value' => (old('room_name') ? old('room_name') : ''),'attribute' => 'required autofocus','form_class' => 'col-md-12', 'class' => 'room_name', 'required' => 'y'])!!}

							{!!view($view_path.'.builder.file',['name' => 'denah_image','label' => 'Denah Image','value' => '','type' => 'file','file_opt' => ['path' => $image_path],'upload_type' => 'single-image','class' => 'col-md-12','note' => 'Note: File Must jpeg,png,jpg,gif','form_class' => 'col-md-12', 'required' => 'n'])!!}
						</div>
					</div>

					<div class="tab-pane" id="seat">	
						<div class="row">
							{!!view($view_path.'.builder.text',['type' => 'number','name' => 'total_seat','label' => 'Total Seat','value' => (old('total_seat') ? old('total_seat') : 1),'attribute' => 'required autofocus','form_class' => 'col-md-12', 'class' => 'total_seat', 'required' => 'y'])!!}
