...
<form role="form" method="post" action="{{url($path)}}" enctype="multipart/form-data">
	<div class="portlet light bordered">
    	...
    	<div class="portlet-body form">
	  		...
	  		<div class="row">
			  	{!!view($view_path.'.builder.text',['type' => 'text','name' => 'youtube_url','label' => 'Youtube URL','value' => (old('youtube_url') ? old('youtube_url') : ''),'attribute' => 'autofocus required','form_class' => 'col-md-6 youtube_url_wrapper', 'class' => 'youtube_url', 'placeholder' => 'https://www.youtube.com/watch?v=We9fYv6iLWg'])!!}
