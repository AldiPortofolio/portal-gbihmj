...
<form role="form" method="post" action="{{url($path)}}" enctype="multipart/form-data">
	<div class="portlet light bordered">
    	...
    	<div class="portlet-body form">
	  		...
	  		<div class="row">
				{!!view($view_path.'.builder.select',['name' => 'church_id','label' => 'Church','value' => (old('church_id') ? old('church_id') : ''),'attribute' => 'required','form_class' => 'col-md-12', 'data' => $church, 'class' => 'select2 church_id', 'onchange' => ''])!!}
				...
				{!!view($view_path.'.builder.select',['name' => 'category_event','label' => 'Category Event','value' => (old('category_event') ? old('category_event') : ''),'attribute' => 'required','form_class' => 'col-md-12', 'data' => $category_event, 'class' => 'select2 category_event', 'onchange' => ''])!!}

				{!!view($view_path.'.builder.text',['type' => 'text','name' => 'title','label' => 'Title','value' => (old('title') ? old('title') : ''),'attribute' => 'required autofocus','form_class' => 'col-md-12', 'class' => 'title', 'required' => 'n'])!!}
				
				{!!view($view_path.'.builder.text',['type' => 'text','name' => 'sub_title','label' => 'Subtitle','value' => (old('sub_title') ? old('sub_title') : ''),'attribute' => 'required autofocus','form_class' => 'col-md-12', 'class' => 'sub_title', 'required' => 'n'])!!}
				
				{!!view($view_path.'.builder.text',['type' => 'text','name' => 'content','label' => 'Content','value' => (old('content') ? old('content') : ''),'attribute' => 'required autofocus','form_class' => 'col-md-12', 'class' => 'content', 'required' => 'n'])!!}

				{!!view($view_path.'.builder.file',['name' => 'image','label' => 'Event Image','value' => '','type' => 'file','file_opt' => ['path' => $image_path],'upload_type' => 'single-image','class' => 'col-md-12','note' => 'Note: File Must jpeg,png,jpg,gif','form_class' => 'col-md-12', 'required' => 'n'])!!}

				{{-- {!!view($view_path.'.builder.text',['type' => 'text','name' => 'speaker','label' => 'Speaker','value' => (old('speaker') ? old('speaker') : ''),'attribute' => 'required autofocus','form_class' => 'col-md-12', 'class' => 'speaker', 'required' => 'y'])!!} --}}
					...
					<table class="table table-bordered table_timeEvent">
						...
						<tbody>
							<tr>
								...
								<div class="col-md-6" id="">
									<div class="form-group form-md-line-input">
										<input type="text" id="event_time" class="form-control event_time" name="event_timeSpeaker[]" value="" readonly="" placeholder="Time">
										<!-- <label for="form_floating_Hqd">Event Date <span class="" aria-required="true">*</span></label> -->
										<small></small>
									</div>
								</div>
