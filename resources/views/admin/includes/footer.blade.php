<div class="page-footer">
    <!-- <div class="page-footer-inner"> 2017 - {{date('Y')}} &copy; Copyright by 
    	<a href="{{url('http://jetfi.co.id/')}}">Jetfi</a>
    </div> -->
...
<script src="{{asset('components/plugins/counterup/jquery.waypoints.min.js')}}" type="text/javascript"></script>
<script src="{{asset('components/plugins/counterup/jquery.counterup.min.js')}}" type="text/javascript"></script>
<script src="{{asset('components/plugins/bootstrap-colorpicker/js/bootstrap-colorpicker.js')}}" type="text/javascript"></script>
<script type="text/javascript" src="{{asset('components/plugins/cropper/cropper.min.js')}}"></script>  
<script src="{{asset('components/plugins/bootstrap-growl/jquery.bootstrap-growl.min.js')}}"></script>
<script src="{{asset('components/plugins/sweetalert2/sweet-alert.min.js')}}"></script>
<script src="{{asset('components/back/js/app.min.js')}}"></script>
<script src="{{asset('components/back/js/layout.min.js')}}"></script>
...
@stack('scripts')
<script src="{{asset('components/back/js/kyubi.js?v=2')}}"></script>
<!-- <script>
