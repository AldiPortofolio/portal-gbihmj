...
class ChannelController extends KyubiController {
	...
	public function __construct()
	{
		...
		$this->root_link 		= "channel";
		$this->model 			= new Channel;

		$this->bulk_action			= true;
		$this->bulk_action_data 	= [3];

        $this->image_path 			= 'components/both/image/music/';
		$this->data['image_path'] 	= $this->image_path;
		$this->image_path2 			= 'components/both/file/';
	...
	public function create(){
		...
		$this->data['title'] 						= "Create Channel";
        ...
        //base_url from Controller.php
        // $this->data['base_url']
		return $this->render_view('pages.channel.create');
	...
	public function store(Request $request){
		...
		$this->model->youtube_url		= $request->youtube_url;
		...
		Alert::success('Successfully add Channel');
	...
	public function edit($id){
		...
		// dd($this->model);
		$this->data['title'] 			= "Edit Channel ".$this->model->id;
		// $this->data['church'] 			= $this->build_array(Church::where('status','y')->get(),'id','name');
		...
		return $this->render_view('pages.channel.edit');
	}
