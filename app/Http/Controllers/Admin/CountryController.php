...
class CountryController extends KyubiController{
	public function __construct(){
		...
		$this->image_path 		= 'components/both/image/country/';
	...
	public function create(){
		...
		$this->data['title'] = "Create Country";

		// $this->field = $this->field_create();
		// return $this->build('create');

		return $this->render_view('pages.country.create');
	}
  ...
  //       	// File::delete($path.$user->images);
	...
	public function edit($id){
		$this->data['data1'] = $this->model->find($id);
		$this->data['title'] = "Edit Country ".$this->data['data1']->country_name;
		$this->model = $this->model->find($id);
		$this->field = $this->field_edit();
	...
	public function update(Request $request, $id){
		...
		$this->model->country_name 			= $request->country_name;
		// dd($this->model);
		$this->model->save();

		Alert::success('Successfully edit Province');
		return redirect()->to($this->data['path']);
	}							
