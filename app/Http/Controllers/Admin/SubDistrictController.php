...
class SubdistrictController extends KyubiController{
	public function __construct(){
		parent::__construct();
		$this->middleware($this->auth_guard);
		$this->middleware($this->role_guard);
		$this->primary_field	= 'id';
		$this->title			= 'Subdistrict';
		$this->root_link		= 'subdistrict';
		...
		$this->image_path 			= 'components/both/image/district/';
  ...
  //       	// File::delete($path.$user->images);
	...
	public function edit($id){
		$this->data['data'] 	= $this->model->join('rgn_district', 'rgn_district.id', 'rgn_subdistrict.district_id')->join('city', 'city.id', 'rgn_district.city_id')->select('rgn_subdistrict.*', 'rgn_district.city_id', 'city.province_id')->find($id);
		// dd($this->data['data']);
		$this->data['title'] 	= "Edit ".$this->title." ".$this->data['data']->category_name;
		$this->data['province'] = Province::get();
		$this->data['city'] 	= City::get();
		$this->data['district'] = District::get();
		
		// $this->model = $this->model->find($id);
		// $this->field = $this->field_edit();
		// return $this->build('edit');
		return $this->render_view('pages.subdistrict.edit');
	}
	...
	public function update(Request $request, $id){
		...
		$this->model->district_id 	= $request->district;
		// dd($this->model);
		$this->model->save();
		...
		Alert::success('Successfully edit '.$this->title);
		return redirect()->to($this->data['path']);
	}							
