...
class ProvinceController extends KyubiController{
	public function __construct(){
		...
		$this->image_path 		= 'components/both/image/province/';
  ...
  //       	// File::delete($path.$user->images);
	...
	public function edit($id){
		$this->data['data1'] = $this->model->find($id);
		$this->data['title'] = "Edit Category Mitra ".$this->data['data1']->category_name;
		// dd('test');
		$this->model = $this->model->find($id);
		$this->field = $this->field_edit();
		return $this->build('edit');
		// return $this->render_view('pages.category-mitra.edit');
	}
