...
class DistrictController extends KyubiController{
  ...
  //       	// File::delete($path.$user->images);
	...
	public function edit($id){
		$this->data['data'] 	= $this->model->join('city', 'city.id', 'rgn_district.city_id')->select('rgn_district.*', 'city.province_id')->find($id);
		// dd($this->data['data']);
		$this->data['title'] 	= "Edit City ".$this->data['data']->category_name;
		...
		return $this->render_view('pages.district.edit');
	}
